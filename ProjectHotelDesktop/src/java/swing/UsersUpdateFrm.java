 ...
 * @author Ziyi
 */
public class UsersUpdateFrm extends javax.swing.JFrame {
    
    private UserAdminSLBeanRemote userAdminSLBean;
    BigDecimal userId;
    
    public UsersUpdateFrm(BigDecimal userId) {
        initComponents();
         
        userAdminSLBean = RoomsMainFrm.getUserAdminSLBean();
        this.userId = userId;
        Users selectedUser = (Users)userAdminSLBean.getById(userId);
        txtFN.setText(selectedUser.getFirstname().toString());
        txtLN.setText(selectedUser.getLastname().toString());
        txtPW.setText(selectedUser.getPassword());
        txtEmail.setText(selectedUser.getEmail().toString());
        txtPhone.setText(selectedUser.getPhone().toString());
        txtAddr.setText(selectedUser.getAddress().toString());
        txtCity.setText(selectedUser.getCity().toString());
        txtState.setText(selectedUser.getState().toString());
        txtCountry.setText(selectedUser.getCountry().toString());
        txtZIP.setText(selectedUser.getZip().toString());
        txtComany.setText(selectedUser.getCompany().toString());
    }
    ...
    private void btnAddListingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddListingActionPerformed
        ...
        try{
                            Users newUser = (Users)userAdminSLBean.getById(userId);
                            ...
                            try{
                                userAdminSLBean.update(newUser);
                                System.out.println("===zeke: A record has been successfully updated. ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsersUpdateFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new UsersUpdateFrm().setVisible(true);
            }
        });
    }
