 ...
 * @author Ziyi
 */
public class BookingInsertFrm extends javax.swing.JFrame {
    
    private RoomAdminSLBeanRemote roomAdminSLBean;
    
    public BookingInsertFrm() {
        initComponents();
    ...
    private void btnAddListingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddListingActionPerformed
        ...
        try{
                            ...
                            newRoom.setPrice(new BigInteger(txtPhone.getText()));
                            newRoom.setCapacity(new BigInteger(txtLN.getText()));
                            newRoom.setImg(txtEmail.getText());
                            newRoom.setFloor(new BigInteger(txtFN.getText()));
                            newRoom.setDescription(txtPW.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookingInsertFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookingInsertFrm().setVisible(true);
            }
        });
    }
